...
public class OneMeasurementTimeSeries extends OneMeasurement 
{
	...
	public static final String GRANULARITY_DEFAULT="10";
...
//	private HashMap<Integer, int[]> returncodes;
	...
	{
		super(name);
		_granularity=Integer.parseInt(GRANULARITY_DEFAULT);
...
//		returncodes=new HashMap<Integer,int[]>();
  ...
  public void exportMeasurements(MeasurementsExporter exporter) throws IOException
  {
    ...
    exporter.write(getName(), "Average Time Between Notifications", (((double)totallatency)/((double)operations)));
    exporter.write(getName(), "Min Time", min);
    exporter.write(getName(), "Max Time", max);
